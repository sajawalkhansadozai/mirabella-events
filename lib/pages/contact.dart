    ...
    return Padding(
      ...
      child: Container(
        ...
        child: DropdownButtonFormField<String>(
          value: value,
          isExpanded: true, // FIXED: Ensure dropdown takes full width
          items: items
              .map(
                (e) => DropdownMenuItem(
                  value: e,
  ...
  return InputDecoration(
    ...
    labelStyle: TextStyle(
      letterSpacing: isSmall
          ? 0.5
          : 1.0, // FIXED: Even less letter spacing on mobile
      fontSize: isSmall ? 10 : 12, // FIXED: Smaller label font
    ),
    ...
    contentPadding: EdgeInsets.symmetric(
      horizontal: isSmall ? 8 : 12, // FIXED: Even less padding on mobile
