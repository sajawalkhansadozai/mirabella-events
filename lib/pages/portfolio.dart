  ...
  Widget build(BuildContext context) {
    ...
    final events = <(String, String, String, String, String, String, String)>[
      ...
      (
        ...
        '50 Years of Love',
        'assets/portfolio/social_1.jpeg',
      ),
      (
        'social',
        'Elegant',
      ...
      (
        ...
        'Chic',
        'May 18, 2025',
        'Memorial Signing Ceremony',
        'Private Lawn, F-6 Islamabad',
        'All-White Theme',
        'assets/portfolio/social_3.jpeg',
      ),
      (
        'social',
        'VIP',
      ...
      (
        ...
        'Sep 7, 2024',
        'Hope for All Gala',
        'Mirabella E-18 Gulshan Sehat Islamabad',
        'Fundraising Gala',
        'assets/portfolio/gala_2.jpeg',
      ),
      (
        'gala',
        'Cultural',
